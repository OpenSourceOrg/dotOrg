<?php
/**
 * Osi Customizer Custom Controls
 *
 */
...
function osi_customize_register( $wp_customize ) {
	...
	*/
	class Osi_Image_Checkbox_Custom_Control extends WP_Customize_Control {
		/**
		...
		*/
		public function enqueue() {
			wp_enqueue_style( 'osi-custom-controls-css', get_stylesheet_directory() . '/assets/css/customizer-custom.css', array(), '1.0', 'all' );
		}
		/**
	...
	* @link https://github.com/maddisondesigns
	*/
	class Osi_Text_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	...
	* @link https://github.com/maddisondesigns
	*/
	class Osi_Image_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		* The type of control being rendered
		*/
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Osi_Single_Accordion_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'osi-custom-controls-js', get_stylesheet_directory() . '/assets/js/vendor/customizer-custom.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_style( 'osi-custom-controls-css', get_stylesheet_directory() . '/assets/css/customizer-custom.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Osi_Simple_Notice_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Osi_Slider_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'osi-custom-controls-js', get_stylesheet_directory() . '/assets/js/vendor/customizer-custom.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'osi-custom-controls-css', get_stylesheet_directory() . '/assets/css/customizer-custom.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Osi_Toggle_Switch_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Osi_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Osi_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'osi-select2-js', get_stylesheet_directory() . '/assets/js/vendor/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
			wp_enqueue_script( 'osi-custom-controls-js', get_stylesheet_directory() . '/assets/js/vendor/customizer-custom.js', array( 'osi-select2-js' ), '1.0', true );
			wp_enqueue_style( 'osi-custom-controls-css', get_stylesheet_directory() . '/assets/css/customizer-custom.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'osi-select2-css', get_stylesheet_directory() . '/assets/css/select2.min.css', array(), '4.0.13', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Osi_Dropdown_Posts_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 */
	class Osi_Dropdown_Category_Custom_Control extends WP_Customize_Control {
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Osi_TinyMCE_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['ositinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['ositinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
			$this->json['osimediabuttons']    = isset( $this->input_attrs['mediaButtons'] ) && ( true === $this->input_attrs['mediaButtons'] ) ? true : false;
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Osi_Google_Font_Select_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			$this->font_list = $this->osi_getGoogleFonts( 'all' );
			// Decode the default json font value
			$this->font_values = json_decode( $this->value() );
			// Find the index of our default font within our list of Google fonts
			$this->font_list_index = $this->osi_getFontIndex( $this->font_list, $this->font_values->font );
		}
		/**
		 * Enqueue our scripts and styles
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['osifontslist'] = $this->font_list;
		}
		/**
		 * Render the control in the customizer
		 */
		public function render_content() {
			...
			if ( ! empty( $this->font_list ) ) {
				...
				<div class="google_fonts_select_control">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight & style for regular text', 'osi' ); ?></div>
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'osi' ); ?> <strong><?php esc_html_e( 'bold text', 'osi' ); ?></strong></div>
					<div class="weight-style">
		 ...
		 */
		public function osi_getFontIndex( $haystack, $needle ) {
		 ...
		 */
		public function osi_getGoogleFonts( $count = 30 ) {
			// Google Fonts json generated from https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=YOUR-API-KEY
			$font_file = get_stylesheet_directory() . 'lib/google-fonts-alphabetical.json';
			if ( 'popular' === $this->font_order_by ) {
				$font_file = get_stylesheet_directory() . 'lib/google-fonts-popularity.json';
			}
	 ...
	 */
	class WP_Customizeize_Alpha_Color_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'osi-custom-controls-js', get_stylesheet_directory() . '/assets/js/vendor/customizer-custom.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'osi-custom-controls-css', get_stylesheet_directory() . '/assets/css/customizer-custom.css', array( 'wp-color-picker' ), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	class Osi_Alpha_Color_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue() {
			wp_enqueue_style( 'osi-custom-controls-css', get_stylesheet_directory() . '/assets/css/customizer-custom.css', array(), '1.0', 'all' );
			wp_enqueue_script( 'wp-color-picker-alpha', get_stylesheet_directory() . '/assets/js/wp-color-picker-alpha.js', array( 'wp-color-picker' ), '1.0', true );
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Osi_Pill_Checkbox_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'osi-custom-controls-js', get_stylesheet_directory() . '/assets/js/vendor/customizer-custom.js', array( 'jquery', 'jquery-ui-core' ), '1.1', true );
			wp_enqueue_style( 'osi-custom-controls-css', get_stylesheet_directory() . '/assets/css/customizer-custom.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 *
	 */
	class Osi_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'osi-upsell';
		/**
		 * The Upsell URL
		 */
		public $url = '';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="osi_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 */
	if ( ! function_exists( 'osi_url_sanitization' ) ) {
		function osi_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'osi_switch_sanitization' ) ) {
		function osi_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer Sanitized value
	 */
	if ( ! function_exists( 'osi_radio_sanitization' ) ) {
		function osi_radio_sanitization( $input, $setting ) {
	 ...
	 */
	if ( ! function_exists( 'osi_sanitize_integer' ) ) {
		function osi_sanitize_integer( $input ) {
			return (int) $input;
		}
	}
	 ...
	 * @return string Sanitized input
	 */
	if ( ! function_exists( 'osi_text_sanitization' ) ) {
		function osi_text_sanitization( $input ) {
			if ( strpos( $input, ',' ) !== false ) {
				$input = explode( ',', $input );
			}
			if ( is_array( $input ) ) {
	 ...
	 */
	if ( ! function_exists( 'osi_array_sanitization' ) ) {
		function osi_array_sanitization( $input ) {
			if ( is_array( $input ) ) {
				foreach ( $input as $key => $value ) {
					$input[ $key ] = sanitize_text_field( $value );
				}
	 ...
	 * @return string Sanitized input
	 */
	if ( ! function_exists( 'osi_hex_rgba_sanitization' ) ) {
		function osi_hex_rgba_sanitization( $input, $setting ) {
			...
			if ( false === strpos( $input, 'rgba' ) ) {
				...
				$input = 'rgba(' . osi_in_range( $red, 0, 255 ) . ',' . osi_in_range( $green, 0, 255 ) . ',' . osi_in_range( $blue, 0, 255 ) . ',' . osi_in_range( $alpha, 0, 1 ) . ')';
			}
			return $input;
		}
	}
	 ...
	 */
	if ( ! function_exists( 'osi_in_range' ) ) {
		function osi_in_range( $input, $min, $max ) {
			if ( $input < $min ) {
				$input = $min;
			}
			if ( $input > $max ) {
	 ...
	 * @return string Sanitized input
	 */
	if ( ! function_exists( 'osi_google_font_sanitization' ) ) {
		function osi_google_font_sanitization( $input ) {
	 ...
	 * @return string Sanitized input
	 */
	if ( ! function_exists( 'osi_date_time_sanitization' ) ) {
		function osi_date_time_sanitization( $input, $setting ) {
	 ...
	 * @return string Sanitized input
	 */
	if ( ! function_exists( 'osi_range_sanitization' ) ) {
		function osi_range_sanitization( $input, $setting ) {
			...
			return osi_in_range( $number, $min, $max );
		}
	}
