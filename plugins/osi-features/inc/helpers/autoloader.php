 ...
 *
 * @package osi-featuers
 */

namespace Osi\Features\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( OSI_PATH ), $directory, $file_name );
...
spl_autoload_register( '\Osi\Features\Inc\Helpers\autoloader' );
